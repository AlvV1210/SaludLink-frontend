...
export class CitasReprogramarComponent {
  ...
  protected cancel(): void { void this.router.navigate(['/paciente/citas']); }
  protected confirm(): void { void this.router.navigate(['/paciente/citas/confirmada']); }
